...
protocol BoardsFlowLayoutDelegate: ASCollectionDelegate {
    func collectionView(_ collectionView: UICollectionView, layout: BoardsFlowLayout, originalItemSizeAtIndexPath: IndexPath) -> CGSize
    
}

class BoardsFlowLayout: UICollectionViewFlowLayout {
    
    var delegate: BoardsFlowLayoutDelegate!
    var numberOfColumns = 2
    
    /// Array of all attributes for cells in `BoardsFlowLayout`
